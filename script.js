...
if (settingAnimations) {
  ...
  en: { select: 'Select', back: 'Back', legend: 'Legend', compare: 'Compare', theme: 'Theme' },
  sq: { select: 'Zgjidh', back: 'Mbyll', legend: 'Legjenda', compare: 'Krahaso', theme: 'Tema' },
  de: { select: 'Auswählen', back: 'Zurück', legend: 'Legende', compare: 'Vergleichen', theme: 'Thema' },
  fr: { select: 'Sélectionner', back: 'Retour', legend: 'Légende', compare: 'Comparer', theme: 'Thème' },
  ru: { select: 'Выбрать', back: 'Назад', legend: 'Легенда', compare: 'Сравнить', theme: 'Тема' }
  connected: false,
  index: 0,
  lastButtons: [],
  lastMove: 0,
